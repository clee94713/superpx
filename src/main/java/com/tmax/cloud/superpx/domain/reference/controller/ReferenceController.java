...
@Tag(name = "reference", description = "reference api (Branch, Tag)")
public class ReferenceController {
    private final ReferenceService referenceService;

    @Operation(summary = "reference 생성", description = "reference 생성")
    @PostMapping
    public ResponseEntity<DataResponse<ReferenceDTO.ReferenceGet>> createReference(@RequestBody ReferenceDTO.ReferenceCreate referenceDTO) {
    ...
    public ResponseEntity<DataResponse<List<ReferenceDTO.ReferenceGet>>> getReferences(@PathVariable(value = "projectId") Long projectId) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DataResponse<ReferenceDTO.ReferenceGet>> getReference(@PathVariable(value = "id") Long id) {
